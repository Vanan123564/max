...
print("▒█░░░ ▒█░▒█ ▒█▄▄▄ ▒█▄▄▄ ░▒█░░ ▒█▄▄▄█ ▒█▄▄▄█ ▒█▄▄█ ")
print("──────────────────────────────────────────────────────────────────────                ")
print("Bản Quyền By: \033[1;95mPham Anh Tuan Media")
print("\033[1;37mTool Share ảo Token Max Speed Mới Nhất")
print("Anh Em Nào Mua Like Sub Giá Rẻ Liên Hệ Zalo: 0374824173")
...
sr = "\033[1;33m[\033[1;31mLOC\033[1;37mTOOL\033[1;33m]"
def dk():
   a= "\033[1;33m-"*31
...
list_token = []
for i in range(9999):
   tks = input("\033[1;92mNhập Token Facebook Thứ "+str(i+1)+":\033[1;93m ")
   if tks != '':
      list_token.append(tks)
   else:
    break
linkbv = str(input("\033[1;92m Nhập Link Bài Viết: \033[1;93m"))
